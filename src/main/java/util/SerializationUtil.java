...
public class SerializationUtil {
     ...
     */
    public synchronized static <T> void serialize(T t, String filePath) {
    ...
    public synchronized static <T> void serialize(T t, OutputStream outputStream) {
        // 如果对象为null的话，就不参与序列化
        if (t == null) return;
     ...
     */
    @SuppressWarnings("all")
    private synchronized static void mkdirs(String filePath) {
     ...
     * @return 反序列化后的对象
     */
    public synchronized static <T> T deserialize(String fileDir, Class<T> clazz) {
        // 判断文件是否存在
     ...
     */
    @SuppressWarnings("all")
    public synchronized static <T> T deserialize(InputStream inputStream, Class<T> clazz) {
        // 判断文件是否存在
